...
export default function Card({ userName, image, btnText = "Learn More" }) {
  console.log("Props in Card Component:", userName, image);
  return (
    <div className="md:max-w-sm w-full p-6 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
      ...
      <div className="relative overflow-hidden rounded-lg mb-6">
        ...
        <img
          ...
          width={400}
          height={100}
          className="object-cover object-center w-full h-80 transition-transform duration-300 group-hover:scale-110"
        />{" "}
